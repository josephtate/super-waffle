...
try:
    ...
    print("Error: configargparse is required. Install with: pip install 'rlc-cloud-repos[framework]'")
    sys.exit(1)
...
def parse_args(args=None):
    ...
    parser = configargparse.ArgumentParser(
        ...
        default_config_files=['~/.config/rlc-azure-mirrors.conf', '/etc/rlc-azure-mirrors.conf'],
